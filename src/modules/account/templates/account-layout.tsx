...
const AccountLayout: React.FC = ({ children }) => {
  ...
  return (
    <div className="flex-1 small:py-12 small:bg-gray-50 px-4 lg:px-0">
      <div className="flex-1 h-full max-w-5xl mx-auto bg-white flex flex-col">
        ...
        <div className="flex flex-col small:flex-row lg:items-end justify-between small:border-t border-gray-200 px-8 py-12 gap-x-8">
          <div>
