...
const FaqSection: React.FC<any> = (props) => {
    ...
    const questions = [
        ...
        },
        {
            ...
            content:"Yes. Just keep renting until you can keep it forever for one Rupee. Or buy the product earlier by paying off all your monthly payments at once. To see how many months you would need to rent until it is paid off, go to product details page and look for section 'Can I also buy the product I'm renting?' below you can also see the breakdown of how much you will pay over the actual price",
        }
    ]
