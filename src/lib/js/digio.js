...
(function(){
    ...
    digioHandle.prototype = {
        ...
        enachApiSign : function(id, identifier, token_id){
            ...
            this.popup.location = digioService.generateUrl(this.URL[this.environment], url, this.documentId, this.txnId, identifier, token_id, extendedConfig);
        },
        esign: function(ids, identifier, token_id){
            ...
            this.popup.location = digioService.generateUrl(this.URL[this.environment],CONSTANTS.URLS.ESIGN_SUFFIX,this.documentId, this.txnId, identifier, token_id, extendedConfig);
        },
        cancel: function(){
            var that=this;
